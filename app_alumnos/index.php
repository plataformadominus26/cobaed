...
<head>
 ...
 <style>
    /* Burbujas de Chat estilo WhatsApp / Cobaed */
.msg-row {
    display: flex;
    margin-bottom: 10px;
}
...
.msg-bubble.sent {
    background-color: #dcf8c6; /* O var(--cobaed-green) con opacidad */
    background-color: #e3fcef; /* Un verde muy suave */
    color: #004d2c;
...
<li class="nav-item">
    ...
    <div class="feed-card animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
        ...
        <div class="tab-pane fade px-4 pt-5 text-center" id="tab-mas" role="tabpanel">
            ...
            <div class="card card-custom mb-3 border-0 shadow-sm" onclick="abrirChatPsico()">
    <div class="d-flex">
        <div class="bg-primary" style="width: 6px;"></div> <div class="card-body d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fw-bold mb-0">Apoyo Psicológico</h6>
                <small class="text-muted">Espacio seguro y confidencial</small>
            </div>
...
<div class="offcanvas offcanvas-end border-0 shadow-lg" tabindex="-1" id="drawerPsico" style="width: 100%; border-radius: 0;">
    
    <div class="offcanvas-header bg-campestre text-white px-3 py-3 shadow-sm">
        <div class="d-flex align-items-center">
            <button type="button" class="btn text-white me-2" data-bs-dismiss="offcanvas">
                <i class="bi bi-arrow-left fs-4"></i>
            </button>
            <div>
                <h6 class="mb-0 fw-bold">Chat de Apoyo</h6>
                <small class="text-white-50" style="font-size: 0.75rem;">● En línea con Consejero</small>
            </div>
        </div>
        <i class="bi bi-shield-lock-fill fs-4 text-white-50"></i>
    </div>

    <div class="offcanvas-body bg-light p-0 d-flex flex-column">
        
        <div id="chatMessagesArea" class="flex-grow-1 p-3" style="overflow-y: auto; padding-bottom: 80px;">
            <div class="text-center my-4">
                <span class="badge bg-white text-secondary border shadow-sm rounded-pill fw-normal p-2 px-3">
                    La conversación es encriptada y privada.
                </span>
            </div>
            </div>

        <div class="p-2 bg-white border-top d-flex align-items-center gap-2" style="position: sticky; bottom: 0;">
            <input type="text" class="form-control rounded-pill bg-light border-0 py-2" id="psicoInput" placeholder="Escribe aquí...">
            <button class="btn btn-campestre rounded-circle shadow-sm" style="width: 45px; height: 45px;" onclick="enviarMensajePsico()">
    ...
    <script>
    function abrirChatPsico() {
    var myOffcanvas = new bootstrap.Offcanvas(document.getElementById('drawerPsico'));
    myOffcanvas.show();
    scrollearAlFondo();
}   
</script>
