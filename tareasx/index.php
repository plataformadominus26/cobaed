...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/main.css?v=1.07">
    ...
    <!-- Custom CSS -->
     <style>
      ...
      .btUsr{
        ...
        .modal-user .avatar-upload {
            position: relative;
            max-width: 150px;
            margin: auto;
        }

        .modal-user .avatar-preview {
            width: 100%;
            height: 150px;
...
<body>
    ...
    <!-- Modal Window: modalUsers -->
    <div class="modal fade" id="modalUsers" tabindex="-1" aria-labelledby="modalUsersLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUsersLabel">Gestión de Usuarios</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <!-- Aquí puedes agregar el contenido del modal de usuarios -->
                    <p>Seleccione un usuario a quien asignar.</p>
                    <div id="dUsers">
                    </div>
    ...
    <script src="this.js?v=1.20"></script>
